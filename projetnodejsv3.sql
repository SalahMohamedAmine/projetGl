...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 18, 2019 at 12:25 PM
...
INSERT INTO `evalue` (`id_evalue`, `id_etudiant`, `id_matiere`, `review`) VALUES
(1, '29386009', 3, 11.07),
(2, '46628554', 4, 18.94),
(3, '29386009', 6, 65.62),
(4, '42748188', 7, 98.44),
...
--
ALTER TABLE `evalue`
  MODIFY `id_evalue` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `evalue`
  ADD CONSTRAINT `evalue_ibfk_1` FOREIGN KEY (`id_etudiant`) REFERENCES `etudiant` (`cin_etudiant`),
  ADD CONSTRAINT `evalue_ibfk_2` FOREIGN KEY (`id_matiere`) REFERENCES `matiere` (`id_matiere`);
